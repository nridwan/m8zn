...
- docker runner and cloud services such as Github Runner / Gitlab CI, since it's barebone kit, you will need to include tool installation steps before CI/CD steps.
...
This can be found in your firebase "General" Project Settings, for example: `export FIREBASE_APP_ID1:87732788080:android:57b4da20b7760391644db6`
